...
namespace Dorywcza.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<JobOfferEmployee> JobOfferEmployees { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<JobOfferEmployee>()
                .HasKey(a => new {a.JobOfferId, a.EmployeeId});
            ...
            modelBuilder.Entity<JobOfferEmployee>().HasData(
                new JobOfferEmployee()
                {
                    JobOfferId = 1,
                    EmployeeId = 1
                });
